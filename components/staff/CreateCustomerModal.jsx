...
import { X, User, Phone, Mail, Dog, Activity, CheckCircle2 } from 'lucide-react';

export default function CreateCustomerModal({ onClose, initialData }) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-100">
            ...
            <button 
              type="submit" 
              className="flex-1 px-4 py-2.5 bg-chloro text-white font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-md shadow-chloro/20"
            >
