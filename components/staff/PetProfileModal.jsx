      ...
      <div className="bg-white rounded-2xl w-full max-w-4xl h-[85vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex flex-col gap-2 relative justify-center ml-4">
              {isEditing ? (
                <div className="flex gap-2">
                  ...
                  <button onClick={() => { setLocalPet(petForm); setIsEditing(false); handleAction('Đã lưu hồ sơ thú cưng!'); }} className="text-xs font-semibold bg-[#82c696] text-white hover:bg-[#68a87b] px-4 py-2 rounded-lg transition-colors shadow-sm">💾 Lưu lại</button>
                </div>
              ) : (
                <button 
                  onClick={() => { 
        ...
        <div className="flex px-6 border-b border-gray-100 bg-gray-50/50 shrink-0">
          <button 
            ...
            className={`py-4 px-4 font-bold text-sm border-b-2 flex items-center gap-2 transition-colors ${
              activeTab === 'HEALTH' ? 'border-chloro text-understory' : 'border-transparent text-gray-500 hover:text-gray-700'
            }`}
          >
          ...
          <button 
            ...
            className={`py-4 px-4 font-bold text-sm border-b-2 flex items-center gap-2 transition-colors ${
              activeTab === 'HISTORY' ? 'border-chloro text-understory' : 'border-transparent text-gray-500 hover:text-gray-700'
            }`}
          >
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  {isEditing ? (
                    ...
                    <div className={`p-4 rounded-lg border ${
                      localPet.allergy_notes && localPet.allergy_notes !== 'Không' 
