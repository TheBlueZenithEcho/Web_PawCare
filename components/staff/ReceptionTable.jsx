      ...
      case 'COMPLETED_SERVICE':
        return (
          <button 
            ...
            className="bg-[#10b981] hover:bg-[#059669] text-white px-4 py-2 rounded-md font-bold text-sm transition-colors shadow-sm flex items-center gap-1"
          >
        ...
        return (
          <div className="flex items-center gap-2">
            ...
            {booking.service_category === 'Hotel' ? (
              <button 
                onClick={() => setActiveModal({ type: 'PAYMENT', data: booking })}
                className="bg-[#10b981] hover:bg-[#059669] text-white px-4 py-1.5 rounded-md font-bold text-sm transition-colors shadow-sm flex items-center gap-1"
              >
                <ShieldCheck size={16} /> Thanh toán
              </button>
            ) : (
