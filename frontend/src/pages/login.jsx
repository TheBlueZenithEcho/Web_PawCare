          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-2 text-center md:text-left">
              <button
                type="submit"
                disabled={loading}
                className="w-full md:w-auto inline-flex items-center justify-center rounded-full bg-[#1B693C] px-10 py-3.5 text-sm font-semibold text-white shadow-md hover:bg-moss-green transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
              >
