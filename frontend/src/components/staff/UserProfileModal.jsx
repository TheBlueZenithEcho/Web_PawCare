...
import { updateCustomer, updatePet } from '@/services/supabase/supabaseUsersApi';

export default function UserProfileModal({ customer, pets, bookings, onClose, onOpenCreateAccount, onSuccess }) {
              ...
              <div className="flex flex-col gap-2 relative">
                {isEditingCustomer ? (
                  <div className="flex gap-2">
                    ...
                    }} className="text-xs font-semibold bg-[#82c696] text-white hover:bg-[#68a87b] px-3 py-1.5 rounded-lg transition-colors shadow-sm">💾 Lưu lại</button>
                  </div>
                ) : (
                  <button
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          {editingPetId === pet.pet_id ? (
                            <div className="flex gap-2 mt-1">
                              ...
                              }} className="text-xs font-semibold bg-blue-600 text-white hover:bg-blue-700 px-3 py-1.5 rounded-lg transition-colors shadow-sm">💾 Lưu</button>
                            </div>
                          ) : (
                            <button
                              onClick={() => {
